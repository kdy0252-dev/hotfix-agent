...
export OBSERVABILITY_SERVICE_DISPLAY_NAME="${OBSERVABILITY_SERVICE_DISPLAY_NAME:-TARGET SERVICE}"
export OBSERVABILITY_REGION="${OBSERVABILITY_REGION:-eu}"
export OBSERVABILITY_APPLICATION="${OBSERVABILITY_APPLICATION:-app}"
export OBSERVABILITY_NAMESPACE_TEMPLATE="${OBSERVABILITY_NAMESPACE_TEMPLATE:-fms-eu-%s}"
export OBSERVABILITY_SERVICE_NAME_TEMPLATE="${OBSERVABILITY_SERVICE_NAME_TEMPLATE:-fms-eu-%s-app}"

export AGENT_MODE="${AGENT_MODE:-REPORT_ONLY}"
export AGENT_FMS_REPOSITORY_PATH="${AGENT_FMS_REPOSITORY_PATH:-${HOME}/workspace/fms}"
export AGENT_ANALYSIS_TTL="${AGENT_ANALYSIS_TTL:-72h}"
